defmodule Api.Message.Call do
  ...
  ```elixir
  using Api.Message.Call, reply: <module>
  ```
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      @after_compile Api.Message.Call
    end
  end

  alias Ecto.Changeset
  alias Api.SocketHandler
  ...
  @callback changeset(struct | nil, Api.json()) :: Ecto.Changeset.t()
